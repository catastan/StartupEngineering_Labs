...
export default function Home() {
  ...
  const handleGetStarted = () => {
    ...
    posthog?.capture("login_cta_clicked", {
      cta_location: "hero",
    });
    router.push("/login");
  };
        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <section className="mb-20">
            ...
            <p className="text-lg text-gray-600 leading-relaxed">
              Our Todo List App helps you stay organized and manage your daily
              tasks efficiently. With a simple and intuitive interface, you can
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="bg-white p-8 rounded-xl shadow-md transform transition hover:-translate-y-1">
                  ...
                  <p className="text-gray-600">
                    "This task management app has completely transformed how our
                    team collaborates. The intuitive interface and powerful
                    features make it a joy to use daily."
                  </p>
                </div>
                ...
                <div className="bg-white p-8 rounded-xl shadow-md transform transition hover:-translate-y-1">
                  ...
                  <p className="text-gray-600">
                    "The real-time collaboration features are outstanding. We've
                    seen a 40% increase in team productivity since switching to
                    this platform."
                  </p>
                </div>
                ...
                <div className="bg-white p-8 rounded-xl shadow-md transform transition hover:-translate-y-1">
                  ...
                  <p className="text-gray-600">
                    "As a startup founder, I needed something flexible yet
                    powerful. This tool delivers exactly that, helping us stay
                    organized as we scale."
                  </p>
                </div>
              </div>
            </div>
